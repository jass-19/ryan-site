        ...
        <div class="parent-div"> <!-- Moved outside loop -->
            ...
            <div class="box-1">
                <div class="img-sec">
                  ...
                  <div class="logo_image_one"><img src="<?php echo get_field('logo_image_one'); ?>"></div>
                  <div class="seprator"></div>
                  <div class="logo_image_two"><img src="<?php echo get_field('logo_image_two'); ?>"></div>
                  
                </div>
                <div class="heading-1">
<a class="heading-title" href="<?php the_permalink(); ?>"><?php echo get_field('sub_title'); ?></a>
  ...
  <a class="certificate-title" href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                ...
                <div class="heading-3">
                    <h2 class="school-name"><?php echo get_field('school_field'); ?></h2>
                </div>
                <div class="heading-4">
                    <h2 class="discount-info">
                        Use code <span class="span-code"><?php echo get_field('coupon_code'); ?></span>  to save 
                        <span class="span-amount"><?php echo get_field('span_amount'); ?></span> if you enroll before
                        <span class="span-date"><?php echo get_field('span_date'); ?>
                    </h2>
                </div>
                <div class="heading-5">
<?php 
...
$modified_text = preg_replace('/(\$\d+(?:,\d{3})*(?:\.\d{2})?)/', '<span class="span-late-discount">$1</span>', $full_text, 1);
?>
...
<h2 class="late-discount">
    <?php echo $modified_text; ?>
                ...
                <div class="button">
                    <a class="learn-more-btn" href="<?php echo get_field('learn_more_button'); ?>">Learn More</a>
